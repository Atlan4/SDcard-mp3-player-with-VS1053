...
void vs1053::ParseID3_v3(){
  ...
  char itrack[2];
  char iyear[4];
  memset(ititle,  ' ', sizeof(ititle));
  memset(iartist, ' ', sizeof(iartist));
  memset(ialbum,  ' ', sizeof(ialbum));
  memset(itrack,  ' ', sizeof(itrack));  
  memset(iyear,   ' ', sizeof(iyear));  
