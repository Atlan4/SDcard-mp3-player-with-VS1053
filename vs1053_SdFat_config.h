...
// otherwise use pinout of typical Sparkfun MP3 Player Shield.
  ...
  #define MP3_XCS             6//53// 6 //Control Chip Select Pin (for accessing SPI Control/Status registers)
  #define MP3_XDCS             7 //Data Chip Select / BSYNC Pin
  #define MP3_DREQ             2//2 //Data Request Pin: Player asks for more data
