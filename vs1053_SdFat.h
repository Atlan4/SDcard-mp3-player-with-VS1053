 ...
 * \warning This may not be available on all source music files.
 */
#define TRACK_ARTIST            33    //bolo 33
/**
...
class vs1053 {
  public:
    ...
    void trackID3(char*);
    void ParseID3_v1(void);
    void ParseID3_v2(void);
    void ParseID3_v3(void);    
    //void trackTitlev2(char*);
    //void trackArtistv2(char*);
    //void trackAlbumv2(char*);    
    void stopTrack();
    uint8_t isPlaying();
